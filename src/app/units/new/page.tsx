...
// Wrap in Suspense component since it uses useSearchParams
function UnitForm() {
  ...
  if (buildings.length === 0) {
    return (
      <div className="text-center py-10">
        <h3 className="text-white mb-4">You need to create a building first.</h3>
        <Link href="/buildings/new" className="text-blue-400 hover:underline">
