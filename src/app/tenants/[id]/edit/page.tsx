  ...
  if (!tenant) {
    return (
      <div className="min-h-screen bg-slate-50">
        <Navbar />
        <main className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="text-red-600 text-center py-10">Tenant not found.</div>
        </main>
      </div>
    )
  }
        ...
        <div className="md:flex md:items-center md:justify-between mb-8">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Update tenant information. Email cannot be changed.
            </p>
          </div>
          ...
          <div className="px-6 py-8 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                value={tenant.email}
                disabled
                className="block w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-slate-500 sm:text-sm cursor-not-allowed"
              />
              <p className="mt-1.5 text-xs text-slate-400">Email is linked to the tenant&apos;s login and cannot be changed.</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1.5 text-xs text-slate-400">Inactive tenants are moved to the Inactive tab and preserved for records.</p>
            </div>
          </div>
